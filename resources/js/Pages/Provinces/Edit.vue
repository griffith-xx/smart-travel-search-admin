...
const form = useForm({
    name_th: props.province.name_th,
...
const submit = () => {
    form.patch(route("provinces.update", props.province.id));
};
</script>

<template>
    <AppLayout :title="'แก้ไขจังหวัด' + props.province.name_th">
        <Card>
            <template #content>
                <div class="mb-6 flex items-center gap-3">
                    ...
                    <h1 class="text-3xl font-semibold">
                        {{ "แก้ไขจังหวัด" + props.province.name_th }}
                    </h1>
                </div>
